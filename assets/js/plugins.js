    ...
    I = {
        ...
        var e = t,
          ...
          n =
            s.disablePluginBelow instanceof Array
              ? [s.disablePluginBelow[0] || 0, s.disablePluginBelow[1] || 0]
      ...
      _isValid: function (e, a) {
        if (e) {
          ...
          return (
            "#" !== e &&
            -1 !== e.indexOf("#") &&
            ("" === l || decodeURIComponent(l) === decodeURIComponent(n))
          );
        }
      },
      _setup: function () {
          ...
          if (I._isValid.call(null, i, o)) {
            ...
            if (c.length > 0) {
              s.highlightByNextTarget &&
                c !== l &&
                (l ? l.data(C, { tn: c }) : c.data(C, { tn: "0" }), (l = c)),
      ...
      _setOffset: function () {
        ...
        switch ((g || (g = s.offset ? s.offset : 0), f && (g = f), typeof g)) {
          ...
          case "string":
            (a = [
              (t = [g.y ? g.y : g, g.x ? g.x : g])[0] instanceof jQuery
                ? t[0]
                : e(t[0]),
              ...
              a[1].length > 0
                ? ((n = a[1].width()),
                  "fixed" === a[1].css("position") && (n += a[1][0].offsetLeft))
                : (n =
        ...
        t && n && "" !== n
          ...
          : a &&
            ...
            (I._currentTarget.call(null, a)
              ...
              : (!s.keepHighlightUntilNext || e("." + o).length > 1) &&
        ...
        e("._" + C + "-t").removeClass(i + " " + o),
          ...
          s.forceSingleHighlight
            ...
            : (l.slice(0, 1).addClass(i).end().slice(-1).addClass(o),
              n.slice(0, 1).addClass(r).end().slice(-1).addClass(c));
      },
      ...
      _scrollTo: function () {
        (p = I._scrollSpeed.call(null)),
          (u = s.pageEndSmoothScroll ? I._pageEndSmoothScroll.call(null) : u);
        var a = e("html,body"),
      ...
      _autoScrollSpeed: function () {
        var l = e(t).scrollTop(),
          ...
          i = e(a).width(),
          o = [
            p + (p * Math.floor((Math.abs(u[0] - l) / s) * 100)) / 100,
            p + (p * Math.floor((Math.abs(u[1] - n) / i) * 100)) / 100,
          ];
